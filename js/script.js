...
var q = {
    ...
    10: {
        "question": "교양 과제로 글쓰기를 한 당신<br />표절률이 80%가 떠버렸다...",
        "question2": "과제 기한은 2일 남았는데...<br />이때 당신의 해결 방식은?",
        "type": "SN",
        "A": "싹 갈아엎기는 힘드니<br />표절이라고 뜬 내용만 다시 수정한다.",
        "B": "마음 아프지만 눈물을 머금고<br />처음부터 다시 쓰기 시작한다."
    }
}
